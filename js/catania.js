...
//seleccion de fotos 
var milanes = ['./images/cataniasSlider/2.jpeg', './images/cataniasSlider/3.jpeg', './images/cataniasSlider/4.jpg', './images/cataniasSlider/5.jpg', './images/cataniasSlider/6.jpg', './images/cataniasSlider/1.jpeg'];
...
mostrarBtn[0].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteCatania/inte1.jpg)`;
    expandirFunction();
});
mostrarBtn[1].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteCatania/inte2.jpg)`;
    expandirFunction();
});
mostrarBtn[2].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteCatania/inte3.jpg)`;
    expandirFunction();
});
mostrarBtn[3].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteCatania/inte4.jpg)`;
    expandirFunction();
});
mostrarBtn[4].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteCatania/inte5.jpg)`;
    expandirFunction();
});
