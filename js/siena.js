...
//seleccion de fotos 
var sienas = [ './images/Siena2.jpg', './images/Siena3.jpg', './images/Siena.jpg'];
...
mostrarBtn[0].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteSiena/inte1.jpg)`;
    expandirFunction();
});
mostrarBtn[1].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteSiena/inte2.jpg)`;
    expandirFunction();
});
mostrarBtn[2].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteSiena/inte3.jpg)`;
    expandirFunction();
});
mostrarBtn[3].addEventListener('click', function(){
    modal.style.backgroundImage =  `url(./images/inteSiena/inte4.jpg)`;
    expandirFunction();
});
